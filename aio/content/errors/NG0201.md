...
Note that if the missing token is "TemplateRef", you likely simply have a syntax error in your HTML template. See https://stackoverflow.com/questions/35932074/no-provider-for-templateref-ngif-templateref
